...
use Gsnowhawk\Cms\Section;
use Gsnowhawk\View;
use Twig\Loader\FilesystemLoader;

class FixedForm extends \Gsnowhawk\Plugin
{
    /**
     * instance of Gsnowhawk\Cms
     *
     * @var object
     */
    protected $cms;
    ...
    {
        switch ($caller) {
            case 'Gsnowhawk\\Cms\\Entry\\Response':
    ...
    public static function extendTemplateNamespace()
    {
